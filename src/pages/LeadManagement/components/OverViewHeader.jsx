...
const Header = () => {
  ...
  return (
    <header className="flex items-center justify-between px-8 py-2 bg-white shadow-sm border-b border-gray-200" style={{marginLeft:"54px"}}>
        ...
        <div className="flex items-center">
          ...
          <div className="flex flex-col space-y-1">
            <div className="flex items-center gap-2">
              <h1 className="text-xl font-bold">{item.leadName} -</h1>
